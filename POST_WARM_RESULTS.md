...
The `MonotonicOrder` model and NumPy sorted-reference cache were constructed before
...
| Operation | MonotonicOrder | NumPy | Speedup |
|---|---:|---:|---:|
...
and stores the scalar results. `MonotonicOrder` packages that precomputation into
the model and preserves its immutable-data contract.

## Reference queries and new arrays

| Operation | MonotonicOrder | NumPy | Speedup | Contract |
|---|---:|---:|---:|---|
